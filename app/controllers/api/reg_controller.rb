class Api::RegController < ApplicationController
    def create
        ...
        @user = User.new(fio: user_params[:fio], email: user_params[:email], password: BCrypt::Password.create(user_params[:password]), teacher: user_params[:teacher], jwt_validation: random_string(32))
